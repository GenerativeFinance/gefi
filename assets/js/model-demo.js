...
(function (window, document) {
   ...
   * The scorer itself lives in assets/js/model-runtime.js (task 307) so the
   * mock API server can return byte-identical output for the same inputs;
   * this stays a thin delegation, with no behaviour change. */
  function mock(data) {
    return GeFi.modelRuntime.run(cfg, data);
  }
